        ...
        <div class="container" style="max-width: 1050px;">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="#features-flat">Características</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a class="page-scroll" href="{{action('LoginController@login_index')}}">Iniciar sesión</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
    ...
    <header id="hero">
        <div class="container">
            <div class="intro-text">
                ...
                <a href="#contact" class="page-scroll btn btn-xl btn-wire">Contáctenos</a>
            </div>
        </div>
    </header>
