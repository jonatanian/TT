							...
							<div class="panel-body bg-light dark">
								<div class="admin-form">
									...
									<div class="section row mb10">
										...
										<div class="col-md-9">
											<label for="aviso" class="field prepend-icon">
												<textarea class="form-control" name="aviso"></textarea>
									...
									<div class="section row mb10">
										...
										<div class="col-md-9">
											<label for="prioridad" class="field prepend-icon">
												{{ Form::select('prioridad', $prioridad, 3, array('class'=>'form-control')) }}
									...
									<div class="col-md-12 text-right">
										<button type="submit" class="button btn-success"> Publicar aviso </button>
									</div>
									{{Form::close()}}
									...
									<div class="section row mb10">
										<table class="table table-striped">
											...
											<tr>
												<td>{{$aviso->titulo}}</td>
												<td>
													<a href = "{{action('SIGController@editarAvisos', array('IdAviso'=>$aviso->idAviso))}}" class="btn btn-system btn-sm">Editar</a>
