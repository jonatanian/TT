...
@section('content')
	...
	<table class="table table-striped">
		  ...
		  <tr>
			  <td>1</td>
			  <td>Realizar un diagnóstico programa de posgrado con los criterios de CONACYT para establecer un plan para su posible introducción al PNPC.</td>
		  </tr>
		  <tr>
			  <td>2</td>
			  <td>Graduar 4 alumnos de la Maestría en Ingeniería en Producción más Limpia.</td>
		  </tr>
		  <tr>
			  <td>3</td>
			  <td>Impartir dos cursos de servicio externo.</td>
		  </tr>
		  <tr>
			  <td>4</td>
			  <td>Gestionar la capacitación interna del personal del CMPL en al menos 4 temas.</td>
		  </tr>
		  <tr>
			  <td>5</td>
			  <td>Gestionar 2 proyectos vinculados académicamente.</td>
		  </tr>
		  <tr>
			  <td>6</td>
			  <td>Gestionar 8 proyectos de investigación institucional.</td>
		  </tr>
		  <tr>
			  <td>7</td>
