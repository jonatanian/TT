...
@section('content')
	<div class="content-header">
      <h1 class="text-muted">Subdirección Técnica</h1>
      <img class="responsive" src="{{asset('images/organigrama/Tecnica.png')}}" alt="Organigrama de la Subdirección Técnica" height="1000px">
    </div>
    ...
    <div class="content-header">
	  ...
	  <table class="table table-striped">
		  ...
		  <tr>
			  <td>1</td>
			  <td>Participación en proyectos en la categoría de desarrollos tecnológicos, proyectos para la innovación, financiados con recursos internos ó con financiamiento externo; en Producción más Limpia, Eficiencia Energética y/o Medio Ambiente</td>
			  <td>4 proyectos</td>
		  </tr>
		  <tr>
			  <td>2</td>
			  <td>Promover acciones para el mejoramiento ambiental en el CMPL en el marco del Programa Ambiental institucional</td>
			  <td>5 acciones de mejora</td>
		  </tr>
		  <tr>
			  <td>3</td>
			  <td>Editar la Guía de Producción más Limpia en Inmuebles</td>
			  <td>100 ejemplares</td>
		  </tr>
		  <tr>
			  <td>4</td>
			  <td>Obtener la re-acreditación del Laboratorio del CMPL</td>
			  <td>1 re-acreditación</td>
		  </tr>
		  <tr>
			  <td>5</td>
			  <td>Realizar visitas de reconocimiento a empresas públicas y/o privadas</td>
			  <td>20</td>
		  </tr>
		  <tr>
			  <td>6</td>
			  <td>Elaborar propuestas técnico-económicas para la prestación de servicios técnicos y tecnológicos</td>
			  <td>10</td>
		  </tr>
		  <tr>
			  <td>7</td>
			  <td>Realizar proyectos vinculados de Producción más Limpia, Eficiencia Energética y/o Medio Ambiente</td>
			  <td>4 proyectos</td>
		  </tr>
		  <tr>
			  <td>8</td>
			  <td>Realizar diagnósticos de Eficiencia Energética a Nivel Institucional</td>
			  <td>8</td>
		  </tr>
		  <tr>
			  <td>9</td>
			  <td>Mantener actualizadas las medidas de uso eficiente de la energía, agua y manejo de residuos</td>
			  <td>3 acciones de mejora</td>
		  </tr>
		  <tr>
			  <td>10</td>
			  <td>Actualizar los ensayos de Sólidos Sedimentables y Demanda Química de Oxígeno a la normatividad vigente</td>
			  <td>1 actualización</td>
		  </tr>
		  <tr>
			  <td>11</td>
			  <td>Prestar servicios internos y externos en el laboratorio</td>
			  <td>19 servicios</td>
		  </tr>
		  <tr>
			  <td>12</td>
			  <td>Dar seguimiento y cumplimiento al programa de calibración y mantenimiento de equipos de laboratorio</td>
			  <td>6 equipos</td>
		  </tr>
	  </table>
    </div>
	...
	<div class="content-header">
      <h2 class="text-primary">Directorio de la Subdirección Técnica</h2>
    </div>
@stop