            ...
            <div class="panel-menu br-n br-b">
                  ...
                  @if($oficio->Estatus_Id != 105 || $oficio->Estatus_Id != 205 || $oficio->Estatus_Id != 304)
                    ...
                    @if($oficio->IdCaracter != 1)
                      <div class="btn-group">
                        <a href="{{action('OficiosEntrantesController@jefatura_ccp',array('oficioentrante'=>$oficio->IdCorrespondencia))}}" class="btn btn-warning light">
                          <i class="fa fa-reply-all"></i> Enviar CCP
                        </a>
                      </div>
                      <div class="btn-group">
                        <a href="{{action('OficiosEntrantesController@jefatura_turnarA',array('oficioentrante'=>$oficio->IdCorrespondencia))}}" class="btn btn-alert light">
