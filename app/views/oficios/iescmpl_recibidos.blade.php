	...
	<header id="topbar" class="ph10">
		<div class="topbar-left">
			<ul class="nav nav-list nav-list-topbar pull-left">
				<li class="active">
					<a href="{{action('OficiosController@iescmpl_recibidos')}}">Oficios entrantes</a>
				</li>
			</ul>
		</div>
	</header>
                        ...
                        @if($oficio->Estatus_Id != 106 || $oficio->Estatus_Id != 206 || $oficio->Estatus_Id != 305)
	                        <div class="btn-group text-center">
	                          ...
	                          <ul class="dropdown-menu" role="menu">
							    ...
							    <li>
							      <a href="{{action('OficiosEntrantesController@iescmpl_verDetalles',array('correspondencia'=>$oficio->IdCorrespondencia))}}">Ver detalles</a>
							    </li>
							  </ul>
	                        </div>
	                      @endif
