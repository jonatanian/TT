	...
	<header id="topbar" class="ph10">
		<div class="topbar-left">
			<ul class="nav nav-list nav-list-topbar pull-left">
				<li class="active">
					<a href="{{action('OficiosController@jefatura_salientes')}}">Oficios salientes</a>
				</li>
			</ul>
		</div>
		<div class="topbar-right hidden-xs hidden-sm">
			<a href="{{action('OficiosSalientesController@jefatura_nuevoOficio',array('DependenciaE'=>NULL,'AreaE'=>NULL,'EntidadE'=>NULL,'CargoEntidadE'=>NULL))}}" class="btn btn-default btn-sm fw600 ml10">
					  ...
					  <td>{{$oficio->getNombreRevisor($oficio->Observacion_Usuario_Id)}}</td>
                        ...
                        <div class="btn-group text-center">
                          ...
                          <ul class="dropdown-menu" role="menu">
						    ...
						    <li>
						      <a href="{{action('OficiosSalientesController@jefatura_verDetalles',array('correspondencia'=>$oficio->IdCorrespondencia))}}">Ver detalles</a>
						    </li>					    
						    <li class="divider"></li>
