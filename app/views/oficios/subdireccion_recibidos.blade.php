	...
	<header id="topbar" class="ph10">
		<div class="topbar-left">
			<ul class="nav nav-list nav-list-topbar pull-left">
				<li class="active">
					<a href="{{action('OficiosController@subdireccion_recibidos')}}">Oficios entrantes</a>
				</li>
			</ul>
		</div>
	</header>
                      ...
                      <td class="text-center">
                        ...
                        <div class="btn-group text-center">
                          ...
                          <ul class="dropdown-menu" role="menu">
						    ...
						    <li>
						      <a href="{{action('OficiosEntrantesController@subdireccion_verDetalles',array('correspondencia'=>$oficio->IdCorrespondencia))}}">Ver detalles</a>
						    </li>
						  </ul>
                        </div>
                      @endif
