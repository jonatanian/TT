...
@section('Topbar')
	...
	<header id="topbar" class="ph10">
		...
		<div class="topbar-right hidden-xs hidden-sm">
			<a href="{{action('OficiosSalientesController@subdireccion_nuevoOficio',array('DependenciaE'=>NULL,'AreaE'=>NULL,'EntidadE'=>NULL,'CargoEntidadE'=>NULL))}}" class="btn btn-default btn-sm fw600 ml10">
					  ...
					  <td class="text-center">
                        <div class="btn-group text-center">
                          ...
                          <ul class="dropdown-menu" role="menu">
						    ...
						    <li>
						      <a href="{{action('OficiosSalientesController@subdireccion_verDetalles',array('correspondencia'=>$oficio->IdCorrespondencia))}}">Ver detalles</a>
						    </li>					    
						    <li class="divider"></li>
